...
- [ ] Снятие суммы, равной всему балансу.
- [ ] Несколько последовательных снятий.
- [ ] Withdraw на `FROZEN` работает согласно текущей реализации.
- [ ] После успешного снятия статус не меняется.

### InsufficientFundsError

- [ ] Сумма больше баланса.
- [ ] Баланс 0, попытка снять положительную сумму.
- [ ] Баланс после ошибки не изменился.
- [ ] Статус после ошибки не изменился.
...
- [ ] withdraw запрещён для `BLOCKED`.
- [ ] withdraw запрещён для `CLOSED`.
- [ ] баланс после ошибки не меняется.
